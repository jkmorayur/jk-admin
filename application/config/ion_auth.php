...
|
*/
$config['collections']['users']          = 'gtech_users';
$config['collections']['groups']         = 'gtech_groups';
$config['collections']['login_attempts'] = 'gtech_login_attempts';
...
*/
$config['tables']['users']           = 'gtech_users';
$config['tables']['groups']          = 'gtech_groups';
$config['tables']['users_groups']    = 'gtech_users_groups';
$config['tables']['login_attempts']  = 'gtech_login_attempts';
